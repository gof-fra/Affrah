				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							...
							<a class="button2" href="${contextRoot}/products">Shop Now </a>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href=${contextRoot}/single>Sony 80 cm (32 inches)</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="${contextRoot}/single">Artis Speaker</a>
											</h4>
											<div class="info-product-price my-2">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="${contextRoot}/single">Philips Speakers</a>
											</h4>
											<div class="info-product-price my-2">
